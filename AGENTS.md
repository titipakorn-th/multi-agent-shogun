...
version: "3.0"
updated: "2026-02-07"
description: "Codex CLI + tmux multi-agent parallel dev platform with hierarchical specialist team"
...
| D006 | `kill`, `killall`, `pkill`, `tmux kill-server`, `tmux kill-session` directed at **infrastructure** (inbox_watcher, telegram listener, other agents' tmux sessions) | Terminates other agents or infrastructure |
